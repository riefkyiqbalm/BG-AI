  ...
  return (
    <div style={S.root} className="bg-grid">
      ...
      <div style={S.wrap} className="animate-fade-up">
        ...
        <h1 style={S.h1}>
          Halaman Ini <span style={{ color: "var(--teal)" }}>Tidak Ditemukan</span>
        </h1>
        <p style={S.p}>
          URL yang Anda akses tidak ada di sistem SATU-AI. Halaman mungkin telah
          dipindahkan, dihapus, atau memang tidak pernah ada.
        </p>
...
const S: Record<string, React.CSSProperties> = {
  ...
  bigNum: {
    ...
    filter: "drop-shadow(0 0 30px rgba(0,212,200,.35))",
  ...
  btnPrimary: {
    ...
    background: "linear-gradient(135deg,var(--teal),#0080cc)", color: "#fff",
    boxShadow: "0 4px 20px rgba(0,212,200,.25)", display: "inline-flex",
  ...
  suggestBox: {
    ...
    borderRadius: 16, padding: "18px 22px", textAlign: "left", marginBottom: 32,
  },
  suggestTitle: {
  ...
  suggestItem: {
    ...
    color: "var(--muted)", fontSize: 13, transition: "color .15s",
    textDecoration: "none",
  },
  terminal: {
  ...
  cursor: {
    ...
    background: "var(--teal)", animation: "blink 1s infinite", marginLeft: 2,
  },
};